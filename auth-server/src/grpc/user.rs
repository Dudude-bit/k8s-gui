...
use crate::proto::user::{
    ...
    GetProfileRequest, UpdateProfileRequest, ProfileResponse,
};
...
impl UserService for UserGrpcService {
    async fn get_profile(
        ...
        let profile = self.service.get_profile(user_id).await
    ...
    async fn update_profile(
        ...
        let profile = self.service.update_profile(user_id, update_req).await
            .map_err(|e| Status::internal(e.to_string()))?;
