...
export async function getPodEvents(
  ...
  return invoke<EventInfo[]>("get_pod_events", {
    pod_name: podName,
    namespace,
  });
}
...
export async function getDeploymentEvents(
  ...
  return invoke<EventInfo[]>("get_deployment_events", {
...
export async function setRegistryCredentials(
  ...
  return invoke<void>("set_registry_credentials", {
...
export async function deleteRegistryCredentials(
  ...
  return invoke<void>("delete_registry_credentials", {
    registry_id: registryId,
  });
}
...
export async function getServiceYaml(
  name: string,
  namespace: string | null
): Promise<string> {
...
export async function getServicePods(
  name: string,
  namespace: string | null
): Promise<PodInfo[]> {
...
export async function getPodMetricsCommand(
  name: string,
  namespace: string
): Promise<PodMetrics | null> {
  return invoke<PodMetrics | null>("get_pod_metrics_command", {
    name,
    namespace,
  });
}
...
export async function getSecretData(
  ...
  return invoke<Record<string, string>>("get_secret_data", {
    name,
    namespace,
    decode,
  });
...
export async function createSecret(
  ...
  return invoke<SecretInfo>("create_secret", {
    name,
    data,
...
export async function getContainerStatuses(
  ...
  return invoke<ContainerStatus[]>("get_container_statuses", {
    name,
    namespace,
  });
}
...
export async function getNodeResources(
  name: string
): Promise<NodeResourceUsage> {
  return invoke<NodeResourceUsage>("get_node_resources", { name });
}

export async function getNodeConditions(
  name: string
): Promise<NodeCondition[]> {
...
export async function registerUser(
  ...
  return invoke<void>("register_user", {
    email,
    password,
...
export async function listDeployments(
  filters: DeploymentFilters | null
...
export async function searchPodLogs(
  ...
  return invoke<LogLine[]>("search_pod_logs", {
    pod_name: podName,
    namespace,
    query,
    container,
...
export async function getMultiContainerLogs(
  ...
  namespace: string | null,
  tailLines: number | null
): Promise<Record<string, LogLine[]>> {
  return invoke<Record<string, LogLine[]>>("get_multi_container_logs", {
    pod_name: podName,
    namespace,
    tail_lines: tailLines,
  });
...
export async function downloadPodLogs(
  ...
  return invoke<string>("download_pod_logs", {
    pod_name: podName,
    namespace,
    container,
    format,
