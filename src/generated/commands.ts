...
export async function testGcpAuth(): Promise<string> {
  return invoke<string>("test_gcp_auth");
}

export async function testAzureAuth(): Promise<string> {
  return invoke<string>("test_azure_auth");
}
