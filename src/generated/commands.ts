...
import type { AppInfo, AzureProfile, AzureProfileInfo, BatchLogResult, CliAvailability, CliPathsConfig, ClusterInfo, ClusterMetricsResponse, ClusterPreferences, ClusterStats, ConfigMapInfo, ContextBinding, ContextBindingInfo, ContextInfo, CrdDetailInfo, CrdGroup, CronJobDetailInfo, CronJobInfo, CustomResourceDetailInfo, CustomResourceInfo, DaemonSetDetailInfo, DaemonSetInfo, DebugConfig, DebugOperation, DebugResult, DebugStatus, DeploymentInfo, EndpointsInfo, EventFilters, EventInfo, FrontendLogEntry, GcpProfile, GcpProfileInfo, HelmChartSearchResult, HelmInstallOptions, HelmRelease, HelmReleaseDetail, HelmRepository, HelmRevision, InfrastructureBuilderStateDto, IngressInfo, JobDetailInfo, JobInfo, LogLine, ManifestResult, NamespaceInfo, NodeFilters, NodeInfo, NodeMetricsResponse, PersistentVolumeClaimInfo, PersistentVolumeInfo, PodFilters, PodInfo, PodMetricsResponse, PortForwardConfigInfo, PortForwardConfigPayload, PortForwardRequest, PortForwardSessionInfo, RecentItem, RegistryAuth, RegistryAuthStatus, RegistryConfigInfo, RegistryImageResult, RegistryImportEntry, RegistrySearchRequest, ResourceFilters, ResourceListItem, ResourceQuery, ResourceReferences, RolloutStatus, SecretFilters, SecretInfo, ServiceFilters, ServiceInfo, StatefulSetDetailInfo, StatefulSetInfo, StorageClassInfo, StreamLogConfig, ThemeConfig, UpdaterConfig, YamlHistoryEntryDto } from "./types";
...
export async function openPodShell(namespace: string, pod: string, container: string | null, shell: string | null): Promise<string> {
  return invoke<string>("open_pod_shell", { namespace, pod, container, shell });
}

export async function openProcessShell(command: string, args: string[], env: Record<string, string>): Promise<string> {
