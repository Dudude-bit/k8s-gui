...
import type { AppInfo, AzureProfile, AzureProfileInfo, BatchLogResult, CliPathsConfig, ClusterInfo, ClusterMetricsResponse, ClusterPreferences, ClusterStats, ConfigMapInfo, ContextBinding, ContextBindingInfo, ContextInfo, CrdDetailInfo, CrdGroup, CronJobDetailInfo, CronJobInfo, CustomResourceDetailInfo, CustomResourceInfo, DaemonSetDetailInfo, DaemonSetInfo, DebugConfig, DebugOperation, DebugResult, DebugStatus, DeploymentInfo, EndpointsInfo, EventFilters, EventInfo, FrontendLogEntry, GcpProfile, GcpProfileInfo, HelmAvailability, HelmChartSearchResult, HelmInstallOptions, HelmRelease, HelmReleaseDetail, HelmRepository, HelmRevision, InfrastructureBuilderStateDto, IngressInfo, JobDetailInfo, JobInfo, KubectlAvailability, LicenseStatus, LogLine, ManifestResult, NamespaceInfo, NodeFilters, NodeInfo, NodeMetricsResponse, PaymentHistoryResponse, PersistentVolumeClaimInfo, PersistentVolumeInfo, PodFilters, PodInfo, PodMetricsResponse, PortForwardConfigInfo, PortForwardConfigPayload, PortForwardRequest, PortForwardSessionInfo, RecentItem, RegistryAuth, RegistryAuthStatus, RegistryConfigInfo, RegistryImageResult, RegistryImportEntry, RegistrySearchRequest, ResourceFilters, ResourceListItem, ResourceQuery, ResourceReferences, RolloutStatus, SecretFilters, SecretInfo, ServiceFilters, ServiceInfo, StatefulSetDetailInfo, StatefulSetInfo, StorageClassInfo, StreamLogConfig, ThemeConfig, UpdaterConfig, UserProfile, YamlHistoryEntryDto } from "./types";
...
export async function getStatefulset(name: string, namespace: string | null): Promise<StatefulSetDetailInfo> {
  return invoke<StatefulSetDetailInfo>("get_statefulset", { name, namespace });
}

export async function getStatefulsetYaml(name: string, namespace: string | null): Promise<string> {
  return invoke<string>("get_statefulset_yaml", { name, namespace });
}

export async function deleteStatefulset(name: string, namespace: string | null): Promise<void> {
...
export async function getDaemonset(name: string, namespace: string | null): Promise<DaemonSetDetailInfo> {
  return invoke<DaemonSetDetailInfo>("get_daemonset", { name, namespace });
}

export async function getDaemonsetYaml(name: string, namespace: string | null): Promise<string> {
  return invoke<string>("get_daemonset_yaml", { name, namespace });
}

export async function deleteDaemonset(name: string, namespace: string | null): Promise<void> {
...
export async function getJob(name: string, namespace: string | null): Promise<JobDetailInfo> {
  return invoke<JobDetailInfo>("get_job", { name, namespace });
}

export async function getJobYaml(name: string, namespace: string | null): Promise<string> {
  return invoke<string>("get_job_yaml", { name, namespace });
}

export async function deleteJob(name: string, namespace: string | null): Promise<void> {
...
export async function getCronjob(name: string, namespace: string | null): Promise<CronJobDetailInfo> {
  return invoke<CronJobDetailInfo>("get_cronjob", { name, namespace });
}

export async function getCronjobYaml(name: string, namespace: string | null): Promise<string> {
  return invoke<string>("get_cronjob_yaml", { name, namespace });
}

export async function deleteCronjob(name: string, namespace: string | null): Promise<void> {
...
export async function listPortForwardConfigs(): Promise<PortForwardConfigInfo[]> {
  return invoke<PortForwardConfigInfo[]>("list_port_forward_configs");
}

export async function createPortForwardConfig(payload: PortForwardConfigPayload): Promise<PortForwardConfigInfo> {
  return invoke<PortForwardConfigInfo>("create_port_forward_config", { payload });
}

export async function updatePortForwardConfig(id: string, payload: PortForwardConfigPayload): Promise<PortForwardConfigInfo> {
  return invoke<PortForwardConfigInfo>("update_port_forward_config", { id, payload });
}
...
export async function getPodsMetrics(namespace: string | null): Promise<PodMetricsResponse> {
...
export async function checkHelmAvailability(): Promise<HelmAvailability> {
  return invoke<HelmAvailability>("check_helm_availability");
}

export async function listHelmReleasesNative(namespace: string | null): Promise<HelmRelease[]> {
  return invoke<HelmRelease[]>("list_helm_releases_native", { namespace });
}

export async function getHelmReleaseDetail(name: string, namespace: string, revision: number | null): Promise<HelmReleaseDetail> {
  return invoke<HelmReleaseDetail>("get_helm_release_detail", { name, namespace, revision });
}

export async function getHelmHistory(name: string, namespace: string): Promise<HelmRevision[]> {
  return invoke<HelmRevision[]>("get_helm_history", { name, namespace });
}

export async function helmRollback(name: string, namespace: string, revision: number): Promise<string> {
  return invoke<string>("helm_rollback", { name, namespace, revision });
}

export async function helmUninstall(name: string, namespace: string): Promise<string> {
...
export async function helmSearchCharts(keyword: string): Promise<HelmChartSearchResult[]> {
  return invoke<HelmChartSearchResult[]>("helm_search_charts", { keyword });
}

export async function helmInstall(options: HelmInstallOptions): Promise<string> {
  return invoke<string>("helm_install", { options });
}

export async function helmUpgrade(options: HelmInstallOptions): Promise<string> {
  return invoke<string>("helm_upgrade", { options });
}

export async function checkKubectlAvailability(): Promise<KubectlAvailability> {
  return invoke<KubectlAvailability>("check_kubectl_availability");
}
...
export async function debugPodEphemeral(podName: string, namespace: string | null, config: DebugConfig): Promise<DebugOperation> {
  return invoke<DebugOperation>("debug_pod_ephemeral", { podName, namespace, config });
}

export async function debugPodCopy(podName: string, namespace: string | null, config: DebugConfig): Promise<DebugOperation> {
  return invoke<DebugOperation>("debug_pod_copy", { podName, namespace, config });
}

export async function debugNode(nodeName: string, namespace: string | null, config: DebugConfig): Promise<DebugOperation> {
...
export async function getCrdSchema(name: string, version: string | null): Promise<unknown> {
  return invoke<unknown>("get_crd_schema", { name, version });
}

export async function listCustomResources(crdName: string, namespace: string | null, labelSelector: string | null, limit: number | null): Promise<CustomResourceInfo[]> {
  return invoke<CustomResourceInfo[]>("list_custom_resources", { crdName, namespace, labelSelector, limit });
}

export async function getCustomResource(crdName: string, name: string, namespace: string | null): Promise<CustomResourceDetailInfo> {
  return invoke<CustomResourceDetailInfo>("get_custom_resource", { crdName, name, namespace });
}

export async function getCustomResourceYaml(crdName: string, name: string, namespace: string | null): Promise<string> {
  return invoke<string>("get_custom_resource_yaml", { crdName, name, namespace });
}

export async function deleteCustomResource(crdName: string, name: string, namespace: string | null): Promise<void> {
...
export async function saveGcpProfile(name: string, profile: GcpProfile): Promise<void> {
...
export async function getAzureProfile(name: string): Promise<AzureProfile | null> {
  return invoke<AzureProfile | null>("get_azure_profile", { name });
}

export async function saveAzureProfile(name: string, profile: AzureProfile): Promise<void> {
...
export async function getContextBinding(context: string): Promise<ContextBinding> {
  return invoke<ContextBinding>("get_context_binding", { context });
}

export async function saveContextBinding(context: string, binding: ContextBinding): Promise<void> {
...
export async function saveRegistryConfig(id: string, configEntry: RegistryConfigInfo): Promise<void> {
...
export async function getYamlHistory(resourceKey: string): Promise<YamlHistoryEntryDto[]> {
  return invoke<YamlHistoryEntryDto[]>("get_yaml_history", { resourceKey });
}

export async function addYamlHistoryEntry(resourceKey: string, entry: YamlHistoryEntryDto): Promise<void> {
  return invoke<void>("add_yaml_history_entry", { resourceKey, entry });
}

export async function getAllYamlHistory(): Promise<Record<string, YamlHistoryEntryDto[]>> {
  return invoke<Record<string, YamlHistoryEntryDto[]>>("get_all_yaml_history");
}

export async function getInfrastructureState(context: string): Promise<InfrastructureBuilderStateDto> {
  return invoke<InfrastructureBuilderStateDto>("get_infrastructure_state", { context });
}

export async function saveInfrastructureState(context: string, state: InfrastructureBuilderStateDto): Promise<void> {
...
export async function saveUpdaterSettings(settings: UpdaterConfig): Promise<void> {
...
export async function saveClusterPreferences(lastContext: string | null, context: string | null, namespace: string | null): Promise<void> {
  return invoke<void>("save_cluster_preferences", { lastContext, context, namespace });
}
