...
export async function debugPodEphemeral(podName: string, namespace: string | null, config: DebugConfig): Promise<DebugResult> {
  return invoke<DebugResult>("debug_pod_ephemeral", { podName, namespace, config });
}

export async function debugPodCopy(podName: string, namespace: string | null, config: DebugConfig): Promise<DebugResult> {
  return invoke<DebugResult>("debug_pod_copy", { podName, namespace, config });
}

export async function debugNode(nodeName: string, namespace: string | null, config: DebugConfig): Promise<DebugResult> {
  return invoke<DebugResult>("debug_node", { nodeName, namespace, config });
}
